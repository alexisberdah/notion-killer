...
<div class="min-h-screen flex items-center justify-center bg-surface-50 dark:bg-surface-900 px-4">
	<div class="w-full max-w-md">
		<div class="text-center mb-8">
			<div
				class="w-16 h-16 rounded-2xl bg-primary-600 flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4"
			>
				N
			</div>
			<h1 class="text-2xl font-bold">Create your account</h1>
			<p class="text-surface-500 mt-2">Start your journey with Notion Killer</p>
		</div>
		...
		<div class="card p-6">
			<form onsubmit={handleSubmit} class="space-y-4">
				...
				<div>
					...
					<Input type="text" name="name" placeholder="John Doe" bind:value={name} required />
				</div>
				...
				<div>
					...
					<Input
						...
						required
					/>
					<p class="mt-1 text-xs text-surface-500">Must be at least 8 characters</p>
				</div>
			...
			<div class="mt-6">
				<div class="relative">
					...
					<div class="relative flex justify-center text-sm">
						<span class="px-2 bg-white dark:bg-surface-800 text-surface-500">Or continue with</span>
					</div>
				</div>
